    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <nav class="navbar navbar-expand-lg main-navbar sticky">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="../admin/assets/logo/download.png" class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
                    <div class="dropdown-menu dropdown-menu-right pullDown">
                        <div class="dropdown-title">Hello <?php echo $_SESSION['rollno']?></div>
                        <a href="#" class="dropdown-item has-icon"> <i class="far
										fa-user"></i> Profile <?php echo $_SESSION['setno']?>
                        </a>

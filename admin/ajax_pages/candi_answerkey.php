...
papersets.papershiftid = $psid  and papersets.setno = $set and question.secid = $secid and questionimgbylanguage.langid = $langid ORDER by papersets.qno");
$res1->execute();
...
INNER JOIN optionimgbylanguage ON optionimgbylanguage.opid = options.id  where options.qid = $qid and optionimgbylanguage.langid = $langid");
$res2->execute();

...
<!-- Main Content -->
<div class="main-content mncontent">
              ...
              <div class="col-12">
                <div class="card" style="margin-bottom: 10px;">
                  ...
                  <div class="card-body" style="padding-top: 5px;padding-bottom: 0px;">
                    <form action="uploadcenterexcel.php" method="post" enctype="multipart/form-data">                  
                    ...
                    <label class="col-sm-2 col-form-label">Choose File</label>
                      <div class="col-sm-4 custom-file">
                       ...
                       <button type="submit" name="save" class="col-sm-2 btn btn-primary">Submit</button>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header" style="padding: 5px 25px">
                    <a class="btn btn-info" href="centerexcel.php" class="col-sm-2">Download Format</a>
                  </div>
                  <div class="card-body">
                    <table style="width:100%;border:solid;margin-bottom:0px" border=1>
                      ...
                      <tbody>
                        <?php $examdetail = $fetchrecordobj->getcenter(); ?>
                      </tbody>
                    </table>
                  </div>
                </div>

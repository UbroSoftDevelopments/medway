                 ...
                 <div class="col-sm-10">
                     ...
                     <table class="table table-bordered">
                       <tbody>
                         ...
                         <tr>
                           <td><b>Father Name: </b><?php echo $c_detail['father_name']; ?></td>
                           <td><b>DOB: </b><?php echo $c_detail['dob']; ?></td>
                         </tr>
                         <tr>
                           <td><b>Mother Name: </b><?php echo $c_detail['mother_name']; ?></td>
                           <td></td>
                         </tr>
                         <tr>
                           ...
                           //echo $gcandiaddress['address']. " , ". $gcandiaddress['district']. " , ".$gcandiaddress['pincode']." , ". $gcandiaddress['city']." , ".$gcandiaddress['state'] ;?> </td>
                         </tr>
                       </tbody>
                     </table>
                 </div>
                 <div class="col-sm-2 txt-center">
                     <table class="table table-bordered">
                       <tbody>
                         <tr>
                          <?php
                            $str_arr = explode ("../", $c_detail['photo']); 
                            
                          ?>
                           <th scope="row txt-center"><img src="<?php print_r($str_arr[1]); ?>" width="123px" height="165px" /></th>
                         </tr>
                         <!-- <tr>
